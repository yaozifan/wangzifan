...
@interface FollowersController ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,SinaWeiboRequestDelegate>
{
...
- (void)loadData
{
    ...
    [sina requestWithURL : @"friendships/followers.json"
                  params : mutable
              httpMethod : @"GET"
                delegate : self];
}
